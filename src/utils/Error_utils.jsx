  ...
  return (
    <div className='flex flex-col h-screen justify-center items-center'>
      <div className='bg-gray-100 rounded px-4 py-4' style={{ maxWidth: 600 }}>
        ...
        <h2 className='text-center pb-8'>Navigate back to the start page and try again</h2>
        <pre className='break-words whitespace-pre-wrap text-center' style={{ color: 'red' }}>{error.message}</pre>
      </div>
